var mailcacheApp = angular.module('mailcacheApp', []);

mailcacheApp.directive('targetBlank', function(){
  return {
...
mailcacheApp.directive('ngKeyEnter', function () {
...
mailcacheApp.controller('MailCtrl', function ($scope, $http, $sce, $timeout) {
  $scope.host = apiHost;
